...
public abstract class OffBoardSensorClient_Backup implements IOffBoardCtxUpdated {
	...
	public OffBoardSensorClient_Backup(String _hostName,
			IOffBoardCtxUpdated _ctxInterface) {
		this.hostName = _hostName;
		this.ctxInterface = _ctxInterface;

		// try {
		// ctxInterface.getClass()
		// .getMethod("OffBoardActivityNoneDetected", new Class[] {})
		// .invoke(ctxInterface, new Object[] {});
